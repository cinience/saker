...
func TestIsAllowedWSOrigin_NoExplicitOrigins(t *testing.T) {
	...
	if !isAllowedWSOrigin("http://localhost:17000", nil, "localhost:17000") {
		t.Error("localhost should be allowed with nil origins")
	}
	if !isAllowedWSOrigin("http://127.0.0.1:17000", nil, "127.0.0.1:17000") {
		t.Error("127.0.0.1 should be allowed with nil origins")
	}
	if isAllowedWSOrigin("http://evil.com:17000", nil, "myserver:17000") {
...
func TestIsAllowedWSOrigin_SameOrigin(t *testing.T) {
	...
	if !isAllowedWSOrigin("http://[2409:8a28:6e6:b030::1]:17000", nil, "[2409:8a28:6e6:b030::1]:17000") {
		t.Error("same-origin IPv6 should be allowed")
	}
	if !isAllowedWSOrigin("http://192.168.1.100:17000", nil, "192.168.1.100:17000") {
		t.Error("same-origin LAN IP should be allowed")
	}
	if isAllowedWSOrigin("http://evil.com:17000", nil, "192.168.1.100:17000") {
...
func TestIsAllowedWSOrigin_ExplicitOrigins(t *testing.T) {
	...
	if isAllowedWSOrigin("http://evil.com", allowed, "myserver:17000") {
...
func TestIsAllowedWSOrigin_Wildcard(t *testing.T) {
	...
	allowed := []string{"*"}
	if isAllowedWSOrigin("http://anything.com", allowed, "myserver:17000") {
