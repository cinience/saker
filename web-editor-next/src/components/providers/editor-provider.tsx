			...
			try {
				...
				if (isNotFound) {
					try {
						...
						next.set("project", newProjectId);
						// next/navigation router prepends basePath automatically, so
						// passing /editor/?... resolves to the actual editor page
						// (basePath + route = /editor/editor/?...). Preserve the full
						// query so a pending ?import=... payload survives the swap.
